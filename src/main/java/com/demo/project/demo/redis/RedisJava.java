package com.demo.project.demo.redis;
...
public class RedisJava {
    public static void main(String[] args) {
        ...
        //查看服务是否运行
        System.out.println("服务正在运行: " + shardedJedis.ping());

//        keyOPerate(shardedJedis);

//        StringOperate(shardedJedis);

//        ListOperate(shardedJedis);

//        SetOperate(shardedJedis);

//        SortedSetOperate(shardedJedis);

        HashOperate(shardedJedis);
    }

    public static void keyOPerate(Jedis shardedJedis){
        ...
        Set<String> keys = shardedJedis.keys("*");
    ...
    public static void StringOperate(Jedis jedis)
    {
    ...
    public static void ListOperate(Jedis shardedJedis)
    {
    ...
    private static void SetOperate(Jedis jedis)
    {
    ...
    private  static  void SortedSetOperate(Jedis shardedJedis)
    {
    ...
    private static void HashOperate(Jedis shardedJedis)
    {
